...
class Grader():
    ...
    def report(self):
        with open(os.path.join(self.dir_path, 'res.csv'), 'w', newline='', encoding='utf-16') as f:
            fieldnames = ['student_moodle_id', 'student_name', 'assignemtn', 'function', 'execnum', 'f', 'f1', 'f2',
                          'contour', 'sample', 'a', 'b', 'n', 'd', 'maxtime', 'maxerr', 'output', 'expected_output',
                          'error', 'repeats', 'time', 'mark']
